...
export default function ShoppingCart() {
  ...
  function handleDecrement(id: number) {
    const isExistentProduct = products.find((item) => item.id === id);
    if (isExistentProduct?.quantity === 1) {
      removeProduct(isExistentProduct.id);
    } else {
              ...
              {products.map((item) => (
                ...
                >
                  <div className="relative w-[300px]">
                    <CustomeImage product={item} fill />
                  </div>
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                      ...
                      <div className="flex items-center text-sm my-4">
                        ...
                        {item?.rating.rate && (
                          <div className="flex items-center ml-2 mr-6">
                            <ReactStars value={item.rating.rate} edit={false} />
                          </div>
                        )}
                    ...
                    <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 spay ml-5">
